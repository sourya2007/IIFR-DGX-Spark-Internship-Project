...
echo ""
echo "  — Full training + web UI:"
echo "      python dgx_demo.py"
echo ""
echo "  — Quick test (5 epochs):"
echo "      python dgx_demo.py --quick"
echo ""
echo "  — Web UI only (load saved models):"
echo "      python dgx_demo.py --web-only"
echo ""
echo "  — Train only (no web UI):"
echo "      python dgx_demo.py --train-only"
echo ""
echo "  Web UI runs at: http://localhost:7860"
echo "════════════════════════════════════════════════════════"
